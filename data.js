...
var work_list = [
    ...
    ["Інформационні системи менеджменту", "Менеджмент ІТ проектів", "Технології frоnt-еnd розробки"],
    ["Інформационні системи менеджменту", "Менеджмент ІТ проектів", "Технології frоnt-еnd розробки"],
    ["УІТІП"],
...
var work_metod_title_name = [
    "ТРКС", "ОСТСП", "Python", "Інформационні системи менеджменту", "УІТІП", "Софт скилл", "IT управління бізнес процесами", "Менеджмент ІТ проектів", "Технології frоnt-еnd розробки", "Веб технології"
];
var work_metod_title = [
    ...
    [], ["ПЗ  1-2.pdf", "ПЗ  3-4.pdf", "ПЗ  5-6.pdf", "ПЗ  7-8.pdf"], ["ПЗ №1.pdf", "Практичне завдання № 2.pdf", "Практичне завдання № 3.pdf"], [], ["Перелік_завдань_Загальний_опис_2023_1.pdf", "Метод_WTTJS_ПЗ_2023.pdf"]
];
