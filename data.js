...
var work_list = [
    ...
    ["Інформационні системи менеджменту", "Менеджмент проектов", "Фронтенд"],
    ["Інформационні системи менеджменту", "Менеджмент проектов", "Фронтенд"],
    ["УІТІП"],
...
var work_metod_title_name = [
    "ТРКС", "ОСТСП", "Python", "Інформационні системи менеджменту", "УІТІП", "Софт скилл", "IT управління бізнес процесами", "Менеджмент проектов", "Фронтенд", "Веб технології"
];
