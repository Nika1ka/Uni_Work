...
var work_metod_title_name = [
    "ТРКС", "ОСТСП", "Python", "Інформационні системи менеджменту", "УІТІП", "Софт скилл", "IT управління бізнес процесами", "Менеджмент ІТ проектів", "Веб технології", "Cloud"
];
var work_metod_title = [
    ...
    ["МВ_ПЗ_Технології_Cloud_Систем.pdf"]
];
